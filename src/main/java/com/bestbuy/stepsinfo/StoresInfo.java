...
public class StoresInfo {
    ...
    @Step("Creating a new store with name :{0}, type :{1}. address :{2}, address2 :{3}, city :{4}, state :{5}, zip:{6}, lat:{7}")

    public ValidatableResponse createNewStore(String name, String type, String address, String address2,
                                              String city, String state, String zip, float lat) {
    ...
    @Step("Getting the store information created by id:{0}")
    ...
    public ValidatableResponse updateStore(long storeId, String name, String type) {
